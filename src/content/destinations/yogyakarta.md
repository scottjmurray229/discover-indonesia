...
highlights:
  - "Borobudur — the world's largest Buddhist temple, sunrise access available"
  - "Prambanan — spectacular 9th-century Hindu temple complex"
  - "Kraton (Sultan's Palace) — the living heart of Javanese royal culture"
  - "Traditional batik weaving workshops on Jalan Tirtodipuran"
  - "Wayang kulit (shadow puppet) performances at cultural centers"
affiliatePicks:
  - provider: "booking"
    label: "Find Hotels in Yogyakarta"
