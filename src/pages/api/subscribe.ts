...
const GUIDE_NAMES: Record<string, string> = {
  'destination-bali': 'Bali Travel Guide',
  'destination-ubud': 'Ubud Travel Guide',
  'destination-yogyakarta': 'Yogyakarta Travel Guide',
  'destination-komodo': 'Komodo Travel Guide',
  'destination-raja-ampat': 'Raja Ampat Travel Guide',
  'destination-lombok': 'Lombok Travel Guide',
  'destination-gili-islands': 'Gili Islands Travel Guide',
  'destination-nusa-penida': 'Nusa Penida Travel Guide',
  'destination-flores': 'Flores Travel Guide',
  'destination-jakarta': 'Jakarta Travel Guide',
  'destination-lake-toba': 'Lake Toba Travel Guide',
  'destination-medan': 'Medan Travel Guide',
};
  ...
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(135deg,#0D7377,#14B8A6);padding:32px 28px;text-align:center;">
        <h1 style="color:white;font-size:24px;margin:0 0 8px;">Discover Indonesia</h1>
      ...
      <div style="padding:28px;">
        <p style="color:#1A2332;font-size:16px;line-height:1.65;margin:0 0 16px;">
          Welcome! You're now part of the Discover Indonesia community.
        </p>
        ...
        <div style="text-align:center;margin-bottom:24px;">
          <a href="https://discoverindonesia.info/destinations/" style="display:inline-block;background:#0D7377;color:white;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;">Browse All Destinations</a>
        </div>
    ...
    <p style="color:#94A3B8;font-size:11px;text-align:center;margin:20px 0 0;line-height:1.5;">
      You're receiving this because you signed up at discoverindonesia.info.<br>
      <a href="https://discoverindonesia.info/legal/privacy/" style="color:#94A3B8;">Privacy Policy</a>
    </p>
  </div>
</body>
</html>`;
...
async function sendWelcomeEmail(apiKey: string, to: string, guideName: string): Promise<void> {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      subject: `Your ${guideName} — Welcome to Discover Indonesia`,
