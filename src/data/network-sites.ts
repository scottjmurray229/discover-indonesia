...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  { id: 'indonesia', name: 'Discover Indonesia', shortName: 'Indonesia', domain: 'discoverindonesia.info', url: 'https://discoverindonesia.info', flag: '\u{1F1EE}\u{1F1E9}', region: 'southeast-asia', status: 'live', tagline: 'Bali temples, jungle adventures, and 17,000 island escapes' },
...
export const CURRENT_SITE_ID = 'indonesia';
